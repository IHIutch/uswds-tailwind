...
[![Open on npmx.dev](https://npmx.dev/api/registry/badge/version/@uswds-tailwind/accordion-compat)](https://npmx.dev/package/@uswds-tailwind/accordion-compat)
[![Open on npmx.dev](https://npmx.dev/api/registry/badge/license/@uswds-tailwind/accordion-compat)](https://npmx.dev/package/@uswds-tailwind/accordion-compat)

Headless [zag-js](https://zagjs.com/) state machine for the USWDS accordion component. Provides state and accessibility behavior used by `@uswds-tailwind/react` and `@uswds-tailwind/compat`.
...
```bash
npm install @uswds-tailwind/accordion-compat@alpha
```
