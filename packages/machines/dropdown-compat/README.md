...
[![Open on npmx.dev](https://npmx.dev/api/registry/badge/version/@uswds-tailwind/dropdown-compat)](https://npmx.dev/package/@uswds-tailwind/dropdown-compat)
[![Open on npmx.dev](https://npmx.dev/api/registry/badge/license/@uswds-tailwind/dropdown-compat)](https://npmx.dev/package/@uswds-tailwind/dropdown-compat)

Headless [zag-js](https://zagjs.com/) state machine for the USWDS dropdown component. Provides state and accessibility behavior used by `@uswds-tailwind/react` and `@uswds-tailwind/compat`.
...
```bash
npm install @uswds-tailwind/dropdown-compat@alpha
```
