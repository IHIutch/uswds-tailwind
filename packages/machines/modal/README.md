...
[![Open on npmx.dev](https://npmx.dev/api/registry/badge/version/@uswds-tailwind/modal)](https://npmx.dev/package/@uswds-tailwind/modal)
[![Open on npmx.dev](https://npmx.dev/api/registry/badge/license/@uswds-tailwind/modal)](https://npmx.dev/package/@uswds-tailwind/modal)

Headless [zag-js](https://zagjs.com/) state machine for the USWDS modal dialog component. Provides state and accessibility behavior used by `@uswds-tailwind/react` and `@uswds-tailwind/compat`.
...
```bash
npm install @uswds-tailwind/modal@alpha
```
