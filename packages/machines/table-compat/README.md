...
[![Open on npmx.dev](https://npmx.dev/api/registry/badge/version/@uswds-tailwind/table-compat)](https://npmx.dev/package/@uswds-tailwind/table-compat)
[![Open on npmx.dev](https://npmx.dev/api/registry/badge/license/@uswds-tailwind/table-compat)](https://npmx.dev/package/@uswds-tailwind/table-compat)

Headless [zag-js](https://zagjs.com/) state machine for the USWDS sortable table component. Provides state and accessibility behavior used by `@uswds-tailwind/react` and `@uswds-tailwind/compat`.
...
```bash
npm install @uswds-tailwind/table-compat@alpha
```
