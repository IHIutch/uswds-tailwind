import type { FileInputSchema } from '@uswds-tailwind/file-input-compat'
...
export class FileInput extends Component<fileInput.Props, fileInput.Api> {
    initMachine(context: fileInput.Props): VanillaMachine<FileInputSchema> {
...
if (typeof window !== 'undefined') {
    window.FileInput = FileInput as any
    window.fileInputInit = fileInputInit
}
