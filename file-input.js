 ...
 */
function getFileInputContext(el) {
...
function createUniqueID(name) {
  return `${name}-${Math.floor(Date.now().toString() / 1000)}`
}
 ...
 */
function getItemsLabel(fileInputEl) {
 ...
 */
function createTargetArea(fileInputEl) {
 ...
 */
function createVisibleInstructions(fileInputEl) {
 ...
 * @param {HTMLInputElement} fileInputEl - The input element.
 */
function createSROnlyStatus(fileInputEl) {
 ...
 */
function enhanceFileInput(fileInputEl) {
 ...
 */
function removeOldPreviews(dropTarget, instructions) {
 ...
 */
function updateStatusMessage(statusElement, fileNames, fileStore) {
 ...
 * @param {object} fileNames - The selected files found in the fileList object.
 */
function addPreviewHeading(fileInputEl, fileNames) {
 ...
 */
function setPreviewFallback(previewImage, fallbackClass) {
...
function handleChange(e, fileInputEl, instructions, dropTarget) {
 ...
 * @param {HTMLDivElement} dropTarget - The drag and drop target area.
 */
function preventInvalidFiles(e, fileInputEl, instructions, dropTarget) {
 ...
 * @param {HTMLDivElement} dropTarget - The drag and drop target area.
 */
function handleUpload(event, fileInputEl, instructions, dropTarget) {
