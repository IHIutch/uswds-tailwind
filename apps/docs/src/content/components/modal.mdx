...
<ComponentPreview title="Modal Default" mark={[/data-part="[^\"]*"/g, /data-value="[^\"]*"/g, /data-target="[^\"]*"/g]} code={`
  <div>
    <button
...
<ComponentPreview title="Modal Large" mark={[/data-part="[^\"]*"/g, /data-value="[^\"]*"/g, /data-target="[^\"]*"/g]} code={`
  <div>
    <button
      data-part="modal-trigger"
...
<ComponentPreview title="Modal Forced Action" mark={[/data-part="[^\"]*"/g, /data-value="[^\"]*"/g, /data-target="[^\"]*"/g]} code={`
  <div>
    <button
      data-part="modal-trigger"
