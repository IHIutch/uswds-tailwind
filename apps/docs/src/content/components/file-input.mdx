...
<ComponentPreview title="File Input" mark={[/data-part="[^\"]*"/g]} code={`
  <div
...
<ComponentPreview title="File Input Specific Type" code={`
  <div
    data-part="file-input-root"
    class="relative z-0 max-w-lg"
  >
...
<ComponentPreview title="File Input Accept Multiple" ins={["multiple"]} code={`
<div
    data-part="file-input-root"
    class="relative z-0 max-w-lg"
  >
