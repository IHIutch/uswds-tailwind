...
<ComponentPreview title="Checkbox Default" code={`
  <form class="max-w-xs">
    <fieldset>
...
<ComponentPreview title="Checkbox Tile" code={`
  <form class="max-w-xs">
    <fieldset>
      <legend class="leading-snug max-w-56 mb-3">Select any historical figure</legend>
      <div class="space-y-2">
