...
<ContentList>
  ...
  - **Note:** A hint is made up of several (seemingly redundant) elements to account for [progressive enhancement](https://developer.mozilla.org/en-US/docs/Glossary/Progressive_Enhancement) and assisted technology.
