...
<ComponentPreview componentName="Accordion Default" code={`<div
...
<ComponentPreview componentName="Accordion Multiple" code={`
  <div
    data-part="accordion-root"
    data-multiple
    class="space-y-2"
...
{/* <ComponentPreview componentName="Accordion Bordered" variant="accordion-bordered" /> */}
