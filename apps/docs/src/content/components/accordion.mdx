...
<ComponentPreview title="Accordion Default" mark={[/data-part="[^\"]*"/g, /data-value="[^\"]*"/g]} code={`
  <div
...
<ComponentPreview title="Accordion Multiple" mark={[/data-part="[^\"]*"/g, /data-value="[^\"]*"/g]} ins={["data-multiple"]} code={`
  <div
    data-part="accordion-root"
    data-multiple
    class="space-y-2"
...
<ComponentPreview title="Accordion Bordered" mark={[/data-part="[^\"]*"/g, /data-value="[^\"]*"/g]} ins={["border-b-4 border-x-4 border-gray-5"]} code={`
  <div
    data-part="accordion-root"
    class="space-y-2"
  >
