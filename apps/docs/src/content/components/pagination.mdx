...
<ContentList>
  ...
  - #### `<li>`
    ...
    Use an `<li>` **Pagination List Items**. This allows assistive technology to enumerate the items in the pagination and allows shortcuts between list items.
...
<ContentList>
  ...
  - #### `aria-current="page"`
    ...
    **Only use on the "current page" pagination item.**
